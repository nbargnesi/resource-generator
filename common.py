...
data_file_info = {
	...
	'go-biological-processes.belns' : 'gobp.xml.gz.info',
	'go-cellular-component-ids.belns' : 'gocc.xml.gz.info',
	'go-cellular-component.belns' : 'gocc.xml.gz.info',
	...
	'go-biological-processes.beleq' : 'gobp.xml.gz.info',
	'go-cellular-component-ids.beleq' : 'gocc.xml.gz.info',
	'go-cellular-component.beleq' : 'gocc.xml.gz.info',
